# pytorch_distilling
 ...
 其中需要关注soft_loss中，student的logits要经过log_softmax,teacher的logits是经过softmax,最后的soft_loss要乘以tmp **2，因为 softmax 的输入除以了 T，KL loss 关于 logits 的梯度幅值会缩小约 1/T²。Hinton 论文要求在 soft loss 上乘 T² 来补偿
